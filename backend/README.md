...
If you updated the code, install new dependencies:

```shell
npm install
```

This project now uses `multer` to accept multipart/form-data for file uploads (profile pictures, post media).