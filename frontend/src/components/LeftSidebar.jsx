...
export default function LeftSidebar() {
    ...
    return (
        <>
            <Box position="fixed" left={4} top={100} zIndex={20}>
                <VStack spacing={3} align="center">
                    ...
                    <Link as={RouterLink} to={`/chat`}>
                        <IconButton aria-label="Chat" icon={<BsFillChatQuoteFill />} variant="ghost" size="sm" _hover={{ bg: "transparent" }} />
                    </Link>

                    <Link as={RouterLink} to={`/settings`}>
                        <IconButton aria-label="Settings" icon={<MdOutlineSettings />} variant="ghost" size="sm" _hover={{ bg: "transparent" }} />
                    </Link>

                    <Link as="a" href="https://product-trust.onrender.com/" target="_blank" rel="noopener noreferrer" _hover={{ textDecoration: "none" }}>
                        <IconButton aria-label="Shopping" icon={<FaShoppingBag />} variant="ghost" size="sm" _hover={{ bg: "transparent" }} />
                    </Link>
                </VStack>
            </Box>
